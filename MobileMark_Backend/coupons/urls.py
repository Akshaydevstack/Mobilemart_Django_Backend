...
urlpatterns = [
    path('admin/banner/', BannerOfferView.as_view(), name='banner-list-create'),          # GET, POST
    path('admin/banner/<int:offer_id>/', BannerOfferView.as_view(), name='banner-update-delete'),  # PATCH, DELETE
    path('admin/coupons/', AdminCouponManagementView.as_view(), name='coupon-list-create'),
